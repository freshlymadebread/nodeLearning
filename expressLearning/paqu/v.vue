<el-table-column :key="index" :label="thead.label" header-align="center" align="center" >
    <template v-for="(thead, index) in thead.children">
        <el-table-column :key="index"   v-slot="scope"   :label="thead.label" header-align="center" align="center" :width="thead.width" :fixed="thead.position">
        ...
        <!-- <el-table-column :key="index"   v-slot="scope"   :label="thead.label" header-align="center" align="center" >
            {{ scope.row }}
        </el-table-column> -->
    </template>
</el-table-column>